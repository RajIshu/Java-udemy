...
the price of carpeting for rectangular rooms. To calculate the price, you
multiply the area of the floor (width times length) by the price per
square meter of carpet. For example, the area of the floor that is 12 meters
long and 10 meters wide is 120 square meters. To cover the floor with a
...
1. Write a class with the name Floor. The class needs two fields (instance
   ...
   field value to 0, in case the length parameter is less than 0 it needs to
   set the length field value to 0.
...
2. Write a class with the name Carpet. The class needs one field (instance
   ...
   * Method named getCost without any parameters, it needs to return the
     value of cost field
